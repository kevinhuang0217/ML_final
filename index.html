  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    @media (max-width: 980px) {
      ...
      /* 解除手機版的測驗區塊高度限制，讓它自然延伸，解決雙重滾動條衝突 */
...
<body>
  <section class="hero">
    <div class="brand">
      <h1>色彩 VSRA 心理測驗</h1>
      <p>結合色彩心理學與機器學習演算法，用五個生活情境測出你的人格與靈魂底色。</p>
    </div>
  ...
  <script>
    ...
    const QUESTIONS = [
      {
        ...
        options: [
          { label: "隱蔽低調的純黑與深灰", note: "只想當個沒有靈魂的透明人", points: { black: 3, grey: 3, blue: 1, white: 1 }, colors: ["black", "grey"] },
          { label: "腎上腺素爆發的亮黃與鮮橘", note: "準備極限百米衝刺", points: { yellow: 3, orange: 3, red: 1, turquoise: 1 }, colors: ["yellow", "orange"] },
          { label: "裝可憐求同情的奶茶棕與米白", note: "喚醒助教惻隱之心", points: { brown: 3, white: 3, pink: 1, green: 1 }, colors: ["brown", "white"] },
          { label: "故作鎮定的海軍藍與俐落白", note: "輸了成績但氣勢不能輸", points: { blue: 3, white: 3, black: 1, grey: 1 }, colors: ["blue", "white"] }
        ]
      },
      {
        title: "中午 12 點的鎖定螢幕",
      ...
      },
      {
        ...
        options: [
          ...
          { label: "充滿霧氣的極簡溫泉池", note: "安靜得只剩水聲", points: { grey: 3, white: 3, black: 1, blue: 1 }, colors: ["grey", "white"] },
      ...
      },
      {
        ...
        options: [
          ...
          { label: "棕 ＋ 橘：大地秋意組合", note: "像一顆烤地瓜", points: { brown: 3, orange: 3, green: 1, yellow: 1 }, colors: ["brown", "orange"] },
    ...
    const PERSONAS = {
      "LLLL": {
        "name": "快俠 Flash",
        "description": "這位老兄因為動作太慢，連在這份報告裡都不配擁有一句完整的座右銘。他的時間流速跟我們這群凡人完全不在同一個次元。當這個世界已經快轉到了 5G 時代，他的靈魂還停留在撥接上網。你跟他說話，他要過三個工作天才能在大腦裡生成回應；你講一個笑話，他可能等到明年清明節才會突然笑出來。他不是在擺爛，他是真的已經把「慢」昇華成了一種堅不可摧的物理防禦盾牌。",
        "motto": "尼克：「嘿，快俠，想聽個笑話嗎？」快俠：「好......啊......」尼克：「什麼動物有三個駝峰？」快俠：「三......個......駝......峰......的......駱......駝......？」尼克：「懷孕的駱駝！哈......哈......哈......哈！」快俠：.................................................................................................「哈......哈......哈......哈......哈......哈......哈......哈......哈......哈......哈......哈......哈......哈......哈......哈......哈......哈......哈......哈......哈......哈......哈......哈......哈......哈......哈..................................................................................................」",
        "image": "assets/images/flash.jpg"
      },
      "LLLH": {
        "name": "章魚哥 Octupus",
        "description": "這是已經徹底看破資本主義謊言的極致社畜。他的靈魂早就被工作榨乾，眼神裡除了死灰還是死灰。你跟他談夢想、談願景、談團隊合作？他只會冷冷地看著你，像看著一坨垃圾一樣問：「我陪你哈啦，你會給我加薪嗎？」他的人生最高指導原則，也是唯一的原則，就是「六點能不能準時下班」。任何試圖在下班時間攔住他的人，對他來說都是不共戴天的殺父仇人，不管你要他做什麼，他都不會做的。",
        "motto": "不管你要我做什麼工作，我都不會做的。我這輩子只在乎六點能不能準時下班。我陪你哈啦，你會給我加薪嗎？",
        "image": "assets/images/octupus.jpg"
      },
      "LLHL": {
        "name": "統神 GodTone",
        "description": "嘴硬的終極權威，大腦內建一套絕對無敵的防禦與反擊機制。就算他在眾目睽睽之下端著火鍋摔個四腳朝天，連湯帶肉砸在自己臉上，他站起來的第一句話絕對是狂吼：「我一步都沒有退欸，啊這樣算我輸喔？」 你拿牛頓力學去跟他爭論他為什麼會滑倒，他會直接在物理學上超渡你，大罵「50萬拿去啦 乞丐」。他不需要客觀事實，因為他自己就是真理本理。只要他不覺得自己跌倒，那錯的絕對是那盆火鍋跟這個地球的地心引力。",
        "motto": "我端火鍋摔倒，我一步都沒有退欸，啊這樣算我輸喔？50萬拿去啦 乞丐",
        "image": "assets/images/godtone.jpg"
      },
      "LLHH": {
        "name": "周杰倫 JayChou",
        "description": "裝逼界無人能敵的祖師爺。他這輩子大概有 80% 的詞彙量都被封印了，不管遇到多大的場面、看到多扯的事情，他永遠只會嘴角微揚，給出一句極度敷衍卻又莫名充滿霸氣的：「哎呦不錯喔」。你永遠猜不透他這五個字背後到底是在稱讚你，還是在嘲笑你。他自帶一種「我早就看穿一切，但我懶得跟你解釋」的高級氣場，用最低的輸出，打出最強的壓制力。",
        "motto": "哎呦不錯喔",
        "image": "assets/images/jaychou.jpg"
      },
      "LHLL": {
        "name": "盧廣仲 CrowdLu",
        "description": "這傢伙的廢柴程度已經達到了「天人合一」的最高境界。你問他為什麼會站在這個閃閃發光的舞台上，是不是有什麼偉大的夢想？他只會推一下眼鏡，用最無辜、最沒有靈魂的聲音告訴你：「就是因為我買不到票 yeah」。他的人生沒有規劃、沒有野心、沒有掙扎，一切都是順水推舟。他就像是一片隨風飄蕩的落葉，不小心飄到了終點線，然後隨口說了一句「yeah」，就這樣氣死了一票每天努力到吐血的普通人。",
        "motto": "為什麼我會在台上 就是因為我買不到票 yeah",
        "image": "assets/images/crowdlu.jpg"
      },
      "LHLH": {
        "name": "崴寶 Wei",
        "description": "細節控裡的重度強迫症患者，對食物有著令人發毛的變態執著。一般人吃草莓奶油就是吃草莓奶油，但他不行，他不僅要挖出裡面的「顆粒」，還要用一種近乎高潮的語氣讚嘆：「嗯嗯～他的顆粒好好吃喔」，最後還要厚顏無恥地加上一句「崴寶也想吃一下草莓顆粒」。他把自己活成了一個極度嬌貴、需要被世界捧在手掌心上的巨嬰，任何不夠精緻、沒有顆粒感的事物，都入不了他的法眼。",
        "motto": "這個草莓奶油🍓🍓裡面還有顆粒！🍴🍴嗯嗯～😊😊🥵🥵🥵他的顆粒好好吃喔🫨🫨🥚🥚太好了🤓👏👏崴寶也想吃一下草莓顆粒🍓🍓🥚🥚",
        "image": "assets/images/wei.jpg"
      },
      "LHHL": {
        "name": "曾國城 Chainsmoker",
        "description": "這是把胡說八道昇華成一門哲學的通靈大師。他彷彿擁有一雙能看穿平行宇宙的法眼，能把「在古蹟裡抽菸」這種缺德行為，硬生生包裝成一場為了短暫快樂而引發的世紀大災難。他可以用最沉痛、最悲天憫人的語氣，指責別人的菸「燒壞的不只是規矩，還有三個人的未來」，連王子跟粿粿都能被他扯進這個莫名其妙的因果迴圈裡。你聽他講話會覺得自己智商被按在地上摩擦，但他那副深沉的嘴臉又讓你忍不住想問他明天大盤會怎麼走。",
        "motto": "如果當初曾國城願意多花一點時間介入粿粿或王子，他們倆或許根本就不會相識 但他沒有。他選擇在古蹟裡抽菸，就為了那短暫的快樂這一切的崩塌，不是突然的，是從他點燃那根菸開始的 那一刻，他不是在抽菸——他是在親手點燃一場婚姻的毀滅！一根菸，燒壞的不只是規矩，還有三個人的未來！！",
        "image": "assets/images/chainsmoker.jpg"
      },
      "LHHH": {
        "name": "黃大謙 BigYellow",
        "description": "一個把厭世當成呼吸一樣自然的冷面笑匠。當別人都在網路上炫耀跑車名錶時，他可以用最平淡、最無所謂、甚至帶點嫌棄的死魚眼，看著鏡頭說：「我買了一個45美元的燈」。他不需要任何浮誇的動作，只要用那種看透紅塵的超然姿態，就能把這個充滿消費主義陷阱的愚蠢世界嘲諷得體無完膚。他的冷漠不是裝出來的，是他真的覺得在座的各位，包含那盞燈，都很可笑。",
        "motto": "我買了一個45美元的燈",
        "image": "assets/images/bigyellow.jpg"
      },
      "HLLL": {
        "name": "阿公遛妻 sixseven",
        "description": "這傢伙已經脫離了碳基生物的思考範疇，完全是個被網路迷因奪舍的行屍走肉。你跟他講道理，他回你「欸 six seven」；你問他今天吃什麼，他大喊「阿公阿公 67 ↘️↗️」。他的大腦完全沒有任何邏輯過濾系統，隨時隨地都在播放這首毫無意義的洗腦神曲，並且附帶極度詭異的音調起伏。他是那種會在半夜三點的宿舍走廊突然尖叫「阿公！！」 的危險份子，存在本身就是對人類智商的最大挑釁。",
        "motto": "欸six seven🗣️🗣️🔥🔥🔥欸six seven🗣️🗣️🔥🔥🔥six！six！seven🥰🥰欸six seven🗣️🗣️🔥🔥🔥阿公67↗️阿公阿公67↘️↗️阿公67↗️阿公67↗️阿公阿公67↘️↗️阿公！！🥰🥰🥰67！阿公阿公67↘️↗️six seven🗣️🗣️🔥🔥🔥",
        "image": "assets/images/sixseven.gif"
      },
      "HLLH": {
        "name": "過動吉吉 ADHD",
        "description": "你的靈魂是一隻極度敏感且無法忍受噪音的暴躁吉娃娃。你對於那些沒有書、沒有考卷的娛樂場所感到生理上的極度不適，任何混亂與嘈雜都會讓你瞬間崩潰，只想立刻逃回家考取功名、報效國家。你的高敏感防禦機制，就是用讀書來隔絕這個吵鬧的世界。",
        "motto": "我第一次去夜店唯一一次，只進去了3分鐘，我是被同學綁去的 ，剛進去就受不了，那裡沒有書，沒有考卷，沒有老師，太嘈雜了，並不適合我，我只想好好學習，考取功名，報效國家",
        "image": "assets/images/adhd.jpg"
      },
      "HLHL": {
        "name": "孟寶 Meng",
        "description": "你是個一旦談起戀愛就會完全融化成一灘糖水的極度依戀者。你的世界充滿了紀念日與粉紅泡泡，情緒起伏完全取決於另一半的關注度。雖然偶爾會不受控地化身無理取鬧的「怪怪寶」，但只要你的專屬避風港（崴寶）一出現，給你一點細心的保護與安撫，你就能立刻恢復成最甜膩、最黏人的可愛生物。",
        "motto": "崴寶 送了好多禮物給孟寶 🎁🎁但是孟寶很糟糕 👎👎😒😒只準備了這首歌🎤🎶想唱給崴寶聽😳😳這首歌送給崴寶🫰🫰一二三 三百天🥵🥵四五六 六百天🥰🥰🥰不知不覺 在一起永永遠遠🫶🏻🫶🏻崴崴孟孟 一起去日本🇯🇵🇯🇵🏯厲害崴孟💪🏻💪🏻💪🏻讓旅途順暢無阻✈️✈️有時候 孟寶是怪怪寶🤪🤪還好 有崴寶細心保護孟寶😘😘😳崴崴孟孟 旅行三百天厲害崴孟😼😼讓旅途順暢無阻✈️✈️崴孟合作🤝🤝什麼難關都不怕🙅🙅‍♂️孟寶總是心暖暖👨‍❤️‍💋‍👨👨‍❤️‍💋‍👨👨‍👩‍👧‍👧因為崴崴寶 💕💕",
        "image": "assets/images/meng.jpg"
      },
      "HLHH": {
        "name": "阿志 seventeen",
        "description": "這是一尊行動的義氣發電機，荷爾蒙與中二病的完美結晶。他以為自己穿上西裝就是道理，脫下西裝還是道理；走路要扶牆，因為上了他的床。他那雙手只要一搖起「花手」，轉速快到可以直接拿去發電。他動不動就把「110帶我走，119扛你走」 掛在嘴邊，搞得像隨時要去火拚，但實際上可能只是去巷口買包科學麵。他把「一聲兄弟，一生兄弟」 當作人生最高指導原則，雖然看似是個無法無天的社會邊緣人，但其實他最大的宏願，居然是「想給天下的女孩都有一個家」！他不渣，他只是心碎成了很多片，每一片都想給別人溫暖。",
        "motto": "愛我沒結果 除非花手比過我​​ 天會黑，人會變，三分情，七分騙。只在點菸時低頭 只對愛的人溫柔江湖真是一條不歸路。but，讓我再選一次，我一樣要做兄弟不離不棄 是我兄弟人在江湖飄 哪能不挨刀走的是時光 過的是滄桑割線不打霧 街頭愛耍酷甲K孝廉家，甲故變頭家上了我的床 走路要扶牆路還長 別猖狂我把你當兄弟 你把我當煙蒂玫瑰帶刺 人心帶私 宇智波帶土紙包不住火 你包不住我和諧社會 你我都是鼠輩來生願做小公主 只吃雞巴不吃苦一聲兄弟 一生兄弟做兄弟的 不管利益 只講義氣我不渣 我只是想給天下的女孩都有一個家110帶我走，119扛你走當我穿上西裝 我跟你講道理當我脫下西裝 我就是道理",
        "image": "assets/images/seventeen.jpg"
      },
      "HHLL": {
        "name": "芒果醬 MangoJump",
        "description": "完全把現實生活當成廉價熱血青春電影在演的無腦浪漫派。在他的宇宙觀裡，金錢、地位、未來規劃通通都是狗屁，只要有「喔喔喔愛」，他就能靠光合作用活下去。在這個風風雨雨的殘酷世界裡，他最在乎的居然是「你敢會嫌棄 我騎摩托車」？他可以口袋裡只剩一百塊，機車還漏油，卻依然能在紅綠燈前深情款款地對你說：「我對你的感情我要講出來」。你以為他在發瘋，但他只是純度太高的純愛戰士。",
        "motto": "喔喔喔愛 有你的將來\n我對你的感情我講不出來\n在這個風風雨雨的世界\n你敢會嫌棄 我騎摩托車\n喔喔喔愛 有我的未來\n我對你的感情我要講出來\n在這個風風雨雨的世界\n我永遠在這 等你瞭解\n喔喔喔愛 愛",
        "image": "assets/images/mangojump.jpg"
      },
      "HHLH": {
        "name": "王ADEN ADEN",
        "description": "嚴重的主角光環妄想症末期患者。對他來說，整個地球的自轉都是為了配合他的 C 位出道。他滿腦子只想著要在最後一首歌的時候來個驚天地泣鬼神的「大跳」，結果偏偏遇到下雨，或者是台下同學比他還嗨衝上台。一般人笑笑就過了，但他不行！他的情緒會瞬間原地爆炸，覺得全世界都在針對他，委屈得像個被搶走棒棒糖的巨嬰，甚至會在台上悶掉。但最好笑的是，就算心裡已經氣到想報警，他最後的結論依然是：「我應該要把該給同學的最後一段舞給同學」。這份至死不渝的偶像包袱，真的是感天動地。",
        "motto": "因為下雨的關係🌧️我已經前面沒有大😯跳了🕺🏻🕺🏻原本在最後一首😅😅「雙重的時候」的時候👫👫打算「大跳」😱😱😨😨🕺🏻🕺🏻🕺🏻把氣氛拉到最高😍😍🥰🥰🎉🎉⬆️⬆️但同學🧍🏻‍♀️衝上去🏃🏻‍♀️🏃🏻‍♀️🏃🏻‍♀️ 💃🏻💃🏻然後我被影響到了😡😡🙄🙄🧎所以呢😯我覺得我不應該這樣子🥺🥺❌❌(在台上情緒悶掉💔💔)我應該要🤓☝🏻(把該給同學的最後一段舞給同學.)🕺🏻🕺🏻🕺🏻🕺🏻🕺🏻🕺🏻🕺🏻🕺🏻🕺🏻",
        "image": "assets/images/aden.jpg"
      },
      "HHHL": {
        "name": "香蕉葛葛 BananaGG",
        "description": "這傢伙的大腦皮層大概有一半是由砂糖和粉紅泡泡組成的。別人的世界是絕地求生，他的世界是一座名叫「卡加布列島」的歡樂新手村。就算天塌下來，他也會覺得是天空在給他蓋被子。當你正因為生活破爛不堪而崩潰邊緣時，他會用一種純潔無瑕、完全沒有被社會污染過的眼神看著你，然後拉著你的手說：「大家要跟我一起唱！」他不是裝瘋賣傻，他是真的覺得只要跟著小黑猩猩和蜜蜂女皇一起跳舞，這個世界的愛與和平就能被拯救。溫暖到讓人覺得毛骨悚然，正向到逼人發瘋。",
        "motto": "我來到一個島 它叫卡加布列島有隻身穿七彩衣的鳥 對著我微笑我來到一個島 它叫卡加布列島小黑猩猩很有禮貌 歡迎我來到 來到小湖旁 綠色青蛙抬頭望它和蜜蜂女皇竊竊私語在商量la la la~la la la la la la la la la大家要跟我一起唱",
        "image": "assets/images/bananagg.jpg"
      },
      "HHHH": {
        "name": "黑皮體育生 HAPPY",
        "description": "這是一個精神分裂的究極完全體。他的內心小劇場早就把對方祖宗十八代都問候了一遍，大腦瘋狂運轉著「憑甚麼歧視文組」、「理組有比較驕傲嗎」，甚至連「發票要印嗎」、「需要微波嗎」 這種日常對話都能讓他內心燃起熊熊怒火。但最可怕的是，當他心裡正在對你進行降維打擊的同時，他的臉上居然能無縫切換出那種可以去拍牙膏廣告的陽光笑容，用最輕快、最甜美的嗓音對你說出：「冰美式好囉！」 這種把殺氣完美壓縮進服務業精神的偽裝術，絕對是人類演化史上的奇蹟。",
        "motto": "真的覺得憑甚麼歧視文組？理組有比較驕傲嗎，有載具嗎，不都是人憑甚麼搞歧視啊，每次看到這種東西都很燥，發票要印嗎，每次都在那讀什麼理組電機才有出入，當工程師年薪三百萬有比較爽嗎，需要微波嗎，啊文組有這麼差嗎，冰美式好囉，真的很討厭這種自以為幽默的歧視",
    ...
    function renderQuestion() {
      ...
      questionView.innerHTML = `
        <div class="question-kicker"><span class="pill">Question ${currentQuestion + 1}</span></div>
        ...
        <div class="actions">
          ...
          <button class="primary" type="button" id="nextBtn" ${selected === null ? "disabled" : ""}>${currentQuestion === QUESTIONS.length - 1 ? "查看結果" : "下一題"}</button>
        </div>
      `;
      ...
      options.forEach((option, index) => {
        ...
        button.innerHTML = `${icon}<span><strong>${option.label}</strong>${option.note ? `<small>${option.note}</small>` : ''}</span>`;
      ...
      resultView.innerHTML = `
        <div class="result-hero">
          <div class="question-kicker">
            <span class="pill">你的人格圖鑑 ${finalCode}</span>
          </div>
        ...
        <div class="metrics">
            <h3 style="margin:0; font-size:16px; color:#ffffff;">📊 你的情緒剖析</h3>
            ${metricsHtml}
        </div>
        <div class="actions">
